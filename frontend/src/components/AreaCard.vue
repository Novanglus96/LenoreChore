<template>
  ...
  >
    <v-card-title class="text-h5">
      <v-icon
        :icon="props.area.area_icon"
        size="25"
        class="me-1 pb-1"
      ></v-icon>{{props.area.area_name}}
    </v-card-title>
      <v-card-subtitle>{{ props.area.group.group_name }}</v-card-subtitle>
        <v-card-text class="py-0">
          <v-row align="center" no-gutters>
            ...
            <v-col
              ...
              cols="6"
            >
              <strong class="text-accent">{{ props.area.dueCount }}</strong> of <strong class="text-accent">{{ props.area.totalCount }}</strong> Chore(s) Due
            </v-col>
          </v-row>
        </v-card-text>
        <v-expand-transition>
                ...
                <v-col>
                  ...
                  >
                    ...
                    <v-card>
                      ...
                      <v-card-text>Are you sure you want to delete <span class="text-secondary">{{ props.area.area_name }}</span>? This will also delete <span class="text-secondary">{{ props.area.totalCount }}</span> chores!</v-card-text>
                      <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn
        ...
        <v-card-actions>
          ...
          <v-btn @click="expandcard = !expandcard" :icon="expandcard ? 'mdi-chevron-up' : 'mdi-chevron-down'"></v-btn>
        </v-card-actions>
  </v-card>
</template>
