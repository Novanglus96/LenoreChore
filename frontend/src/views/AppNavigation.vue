<template>
  <v-app-bar color="#c8f0ff" density="compact" app>
    ...
    <span class="text-subtitle-2 font-italic text-grey-darken-1">v1.1.1</span
    ><v-spacer></v-spacer>
    <v-menu
      v-model="menu"
    ...
    >
      ...
      <v-card min-width="300">
        <v-list bg-color="accent">
          <v-list-item :prepend-avatar="store.avatar">
        ...
        <v-list>
          <v-list-item v-if="!store.isChild">
            ...
            <v-btn-toggle
              ...
              color="primary"
              mandatory
              @update:modelValue="toggleVacationMode(chorestore.vacation_mode)"
            >
          ...
          <v-list-item v-if="store.isAdmin">
            <div>
              <div class="text-caption">Medium Threshold</div>
              <v-slider
          ...
          <v-list-item v-if="store.isAdmin">
            <div>
              <div class="text-caption">High Threshold</div>
              <v-slider
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            variant="text"
            @click="
              callSaveOptions(chorestore.med_thresh, chorestore.high_thresh)
            "
          >
            Save
          </v-btn>
